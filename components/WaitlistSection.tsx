          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="px-8 py-6 bg-primary hover:bg-primary/90 disabled:opacity-50 text-white rounded-full font-normal text-sm font-['Epilogue'] tracking-widest transition-all uppercase"
              >
